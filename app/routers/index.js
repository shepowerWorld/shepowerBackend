...
route.post('/registrationCounselingSOSTocitizen', regisController.registrationCounselingSOSToCitizen);
...
route.get('/allScheme', adminController.getGovSchemeById);
route.get('/getterritoryScheme', adminController.getAllTerritoryGovSchemes);
route.delete('/deleteScheme', authMiddleware, adminController.deleteGovScheme);
route.put('/updateScheme', authMiddleware, adminController.updateGovScheme);
